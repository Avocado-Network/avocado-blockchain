...
from avocado.plotting.plot_tools import PlotInfo, parse_plot_info
from avocado.protocols import harvester_protocol
from avocado.protocols.farmer_protocol import FarmingInfo
from avocado.protocols.harvester_protocol import Plot
from avocado.protocols.protocol_message_types import ProtocolMessageTypes
from avocado.server.outbound_message import make_msg
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSAvocadoConnection
    ):
        """

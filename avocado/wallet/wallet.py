...
from avocado.wallet.puzzles.puzzle_utils import (
...
from avocado.wallet.secret_key_store import SecretKeyStore
from avocado.wallet.sign_coin_solutions import sign_coin_solutions
...
class Wallet:
    ...
    async def create_spend_bundle_relative_avocado(self, avocado_amount: int, exclude: List[Coin]) -> SpendBundle:
        list_of_solutions = []
        utxos = None
        ...
        if avocado_amount < 0:
            utxos = await self.select_coins(abs(avocado_amount), exclude)
        else:
        ...
        avocado_amount = spend_value + avocado_amount
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries = [{"puzzlehash": newpuzhash, "amount": avocado_amount}]

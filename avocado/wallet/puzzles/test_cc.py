...
from avocado.wallet.puzzles.genesis_by_coin_id_with_0 import create_genesis_or_zero_coin_checker
from avocado.wallet.puzzles.genesis_by_puzzle_hash_with_0 import create_genesis_puzzle_or_zero_coin_checker

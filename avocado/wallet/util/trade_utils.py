...
from avocado.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_solutions:
            ...
            if r:
                ...
                if "avocado" in cc_discrepancies:
                    cc_discrepancies["avocado"] = cc_discrepancies["avocado"] + diff
                else:
                    cc_discrepancies["avocado"] = diff

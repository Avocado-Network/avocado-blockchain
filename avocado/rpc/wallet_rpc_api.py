...
from avocado.cmds.init_funcs import check_keys
from avocado.consensus.block_rewards import calculate_base_farmer_reward
from avocado.pools.pool_wallet import PoolWallet
from avocado.pools.pool_wallet_info import create_pool_state, FARMING_TO_POOL, PoolWalletInfo, PoolState
from avocado.protocols.protocol_message_types import ProtocolMessageTypes
from avocado.server.outbound_message import NodeType, make_msg
...
from avocado.util.keychain import bytes_to_mnemonic, generate_mnemonic
from avocado.util.path import path_from_root
from avocado.util.ws_message import WsRpcMessage, create_payload_dict
from avocado.wallet.cc_wallet.cc_wallet import CCWallet
from avocado.wallet.derive_keys import master_sk_to_singleton_owner_sk
from avocado.wallet.rl_wallet.rl_wallet import RLWallet
from avocado.wallet.derive_keys import master_sk_to_farmer_sk, master_sk_to_pool_sk, master_sk_to_wallet_sk
...
from avocado.wallet.util.backup_utils import download_backup, get_backup_info, upload_backup
from avocado.wallet.util.trade_utils import trade_record_to_dict
from avocado.wallet.util.transaction_type import TransactionType
from avocado.wallet.util.wallet_types import WalletType
from avocado.wallet.wallet_info import WalletInfo
from avocado.wallet.wallet_node import WalletNode
...
class WalletRpcApi:
    def __init__(self, wallet_node: WalletNode):
        ...
        self.service_name = "avocado_wallet"
    ...
    async def _state_changed(self, *args) -> List[WsRpcMessage]:
        ...
        return [create_payload_dict("state_changed", data, "avocado_wallet", "wallet_ui")]
    ...
    async def _check_key_used_for_rewards(
        ...
        farmer_target = config["farmer"].get("avo_target_address")
        pool_target = config["pool"].get("avo_target_address")
        found_farmer = False
        found_pool = False
    ...
    async def create_new_wallet(self, request: Dict):
        ...
        if request["wallet_type"] == "cc_wallet":
            ...
            if request["mode"] == "new":
                ...
                from avocado.pools.pool_wallet_info import initial_pool_state_from_dict

...
from avocado.consensus.pot_iterations import calculate_sp_iters, is_overflow_block
...
from avocado.timelord.iters_from_block import iters_from_block
from avocado.timelord.timelord_state import LastState
from avocado.timelord.types import Chain, IterationType, StateType
from avocado.types.blockchain_format.classgroup import ClassgroupElement
from avocado.types.blockchain_format.reward_chain_block import RewardChainBlock
...
class Timelord:
    def __init__(self, root_path, config: Dict, constants: ConsensusConstants):
        ...
        self.server: Optional[AvocadoServer] = None

...
async def summary(rpc_port: int, wallet_rpc_port: int, harvester_rpc_port: int, farmer_rpc_port: int) -> None:
    ...
    if amounts is not None:
        print(f"Total avocado farmed: {amounts['farmed_amount'] / units['avocado']}")
        print(f"User transaction fees: {amounts['fee_amount'] / units['avocado']}")
        print(f"Block rewards: {(amounts['farmer_reward_amount'] + amounts['pool_reward_amount']) / units['avocado']}")
    ...
    if amounts is None:
        if wallet_not_running:
            print("For details on farmed rewards and fees you should run 'avocado start wallet' and 'avocado wallet show'")
        elif wallet_not_ready:
            print("For details on farmed rewards and fees you should run 'avocado wallet show'")
    else:
        print("Note: log into your key using 'avocado wallet show' to see rewards for each key")

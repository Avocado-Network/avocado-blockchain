...
from avocado.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            mainnet_port = "6865"
            mainnet_introducer = "introducer.avocadonetwork.net"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running avocado services for changes to take effect")

...
from avocado.util.keychain import Keychain, bytes_to_mnemonic, generate_mnemonic
...
def generate_and_print():
    ...
    print(mnemonic)
    print("Note that this key has not been added to the keychain. Run avocado keys add")
    return mnemonic

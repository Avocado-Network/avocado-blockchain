...
from avocado.full_node.mempool import Mempool
from avocado.full_node.mempool_check_conditions import mempool_check_conditions_dict, get_name_puzzle_conditions
...
from avocado.util.clvm import int_from_bytes
from avocado.util.condition_tools import (
    pkm_pairs_for_conditions_dict,
    coin_announcements_names_for_npc,
    puzzle_announcements_names_for_npc,
)
from avocado.util.errors import Err
from avocado.util.generator_tools import additions_for_npc
...
class MempoolManager:
    def __init__(self, coin_store: CoinStore, consensus_constants: ConsensusConstants):
        ...
        # transactions. This prevents spam. This is equivalent to 0.055 AVO per block, or about 0.00005 AVO for two
        # spends.

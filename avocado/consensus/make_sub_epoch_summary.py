...
from avocado.consensus.difficulty_adjustment import (
...
from avocado.consensus.pot_iterations import calculate_ip_iters, calculate_sp_iters, is_overflow_block

...
class ConsensusConstants:
    ...
    # Forks of avocado should change this value to provide replay attack protection
    ...
    # Max coin amount uint(1 << 64). This allows coin amounts to fit in 64 bits. This is around 18M avocado.
    MAX_COIN_AMOUNT: int

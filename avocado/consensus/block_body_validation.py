...
from avocado.consensus.block_root_validation import validate_block_merkle_roots
from avocado.full_node.mempool_check_conditions import mempool_check_conditions_dict
...
from avocado.util.generator_tools import (
    additions_for_npc,

...
from avocado.cmds.init_funcs import avocado_full_version_str
from avocado.protocols.protocol_message_types import ProtocolMessageTypes
from avocado.protocols.shared_protocol import Capability, Handshake
...
from avocado.util.ints import uint8, uint16

# Each message is prepended with LENGTH_BYTES bytes specifying the length
from avocado.util.network import class_for_type, is_localhost

# Max size 2^(8*4) which is around 4GiB
LENGTH_BYTES: int = 4


class WSAvocadoConnection:
    """

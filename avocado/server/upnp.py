            ...
            try:
                ...
                while keep_going:
                    ...
                    if msg[0] == "remap":
                        ...
                        self.upnp.addportmapping(port, "TCP", self.upnp.lanaddr, port, "avocado", "")
                        log.info(
                ...
                log.info(
                    "UPnP failed. This is not required to run avocado, it allows incoming connections from other peers."
                )
                log.info(e)

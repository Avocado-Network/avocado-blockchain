...
from avocado.types.blockchain_format.foliage import Foliage, FoliageTransactionBlock, TransactionsInfo
...
from avocado.types.blockchain_format.vdf import VDFProof

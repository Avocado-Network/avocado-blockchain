...
from avocado.pools.pool_config import PoolWalletConfig, load_pool_config, update_pool_config
from avocado.pools.pool_wallet_info import (
    PoolWalletInfo,
    PoolSingletonState,
    PoolState,
    FARMING_TO_POOL,
...
from avocado.protocols.pool_protocol import POOL_PROTOCOL_VERSION
...
from avocado.pools.pool_puzzles import (
...
class PoolWallet:
    ...
    async def create_new_pool_wallet_transaction(
        ...
        the same pooling puzzle. This puzzle is a `avocado singleton` that is

...
from avocado.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from avocado.farmer.farmer import Farmer
from avocado.protocols import farmer_protocol, harvester_protocol
from avocado.protocols.harvester_protocol import PoolDifficulty
...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        self, new_proof_of_space: harvester_protocol.NewProofOfSpace, peer: ws.WSAvocadoConnection
    ):
        """

...
- Mainnet uses port 6865 and other constants and service names were changed for mainnet.
...
- Testnet is now running at the primary port of 56865. Update your routers appropriately. This opens 6865 for mainnet.
...
- Introducer now makes sure it only sends peer addresses to peers of peers that it can reach on port 6865 or their UPnP port.

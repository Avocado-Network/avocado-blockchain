...
required to run a [Timelord](https://github.com/Avocado-Network/chia-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Avocado-Network/chia-blockchain/blob/main/install-timelord.sh)

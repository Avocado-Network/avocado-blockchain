...
wallet_program_files = set(
    [
        "avocado/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "avocado/wallet/puzzles/cc.clvm",
        "avocado/wallet/puzzles/chialisp_deserialisation.clvm",
        "avocado/wallet/puzzles/rom_bootstrap_generator.clvm",
        "avocado/wallet/puzzles/generator_for_single_coin.clvm",
        "avocado/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "avocado/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "avocado/wallet/puzzles/lock.inner.puzzle.clvm",
        "avocado/wallet/puzzles/p2_conditions.clvm",
        "avocado/wallet/puzzles/p2_delegated_conditions.clvm",
        "avocado/wallet/puzzles/p2_delegated_puzzle.clvm",
        "avocado/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "avocado/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "avocado/wallet/puzzles/p2_puzzle_hash.clvm",
        "avocado/wallet/puzzles/rl_aggregation.clvm",
        "avocado/wallet/puzzles/rl.clvm",
        "avocado/wallet/puzzles/sha256tree_module.clvm",
        "avocado/wallet/puzzles/singleton_top_layer.clvm",
        "avocado/wallet/puzzles/did_innerpuz.clvm",
        "avocado/wallet/puzzles/decompress_puzzle.clvm",
        "avocado/wallet/puzzles/decompress_coin_solution_entry_with_prefix.clvm",
        "avocado/wallet/puzzles/decompress_coin_solution_entry.clvm",
        "avocado/wallet/puzzles/block_program_zero.clvm",
        "avocado/wallet/puzzles/test_generator_deserialize.clvm",
        "avocado/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "avocado/wallet/puzzles/p2_singleton.clvm",
        "avocado/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "avocado/wallet/puzzles/pool_member_innerpuz.clvm",
        "avocado/wallet/puzzles/singleton_launcher.clvm",
        "avocado/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
    ]
)

clvm_include_files = set(
    ["avocado/wallet/puzzles/create-lock-puzzlehash.clvm", "avocado/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "avocado/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to avocado/wallet/puzzles, but not added to `wallet_program_files`
        """

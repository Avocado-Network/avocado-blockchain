...
from avocado.pools.pool_config import PoolWalletConfig
from avocado.util.config import load_config, save_config, create_default_avocado_config
...
def test_pool_config():
    ...
    create_default_avocado_config(test_root, ["config.yaml"])

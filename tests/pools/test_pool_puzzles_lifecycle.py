...
from avocado.wallet.puzzles.p2_conditions import puzzle_for_conditions
from avocado.wallet.puzzles import singleton_top_layer
from avocado.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - avocado.pools.pool_puzzles.py
    - avocado.wallet.puzzles.pool_member_innerpuz.clvm
    - avocado.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""

...
The workflows are located in [../.github/workflows/](https://github.com/Avocado-Network/avocado-blockchain/tree/main/.github/workflows).
...
In the top tests directory, [testconfig.py](https://github.com/Avocado-Network/avocado-blockchain/tree/main/tests/testconfig.py)
...
Set `checkout_blocks_and_plots` to `False` to omit checking out the [test-cache](https://github.com/Avocado-Network/test-cache) repo.

...
from avocado.full_node.mempool_check_conditions import get_name_puzzle_conditions, get_puzzle_and_solution_for_coin
...
from avocado.wallet.puzzles import p2_delegated_puzzle_or_hidden_puzzle
...
def large_block_generator(size):
    ...
    try:
        ...
        #  TODO: Re-enable large-block*.hex but cache in ~/.avocado/subdir

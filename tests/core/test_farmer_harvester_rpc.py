...
from avocado.plotting.plot_tools import stream_plot_info_ph, stream_plot_info_pk
from avocado.protocols import farmer_protocol
from avocado.rpc.farmer_rpc_api import FarmerRpcApi
from avocado.rpc.farmer_rpc_client import FarmerRpcClient
from avocado.rpc.harvester_rpc_api import HarvesterRpcApi
from avocado.rpc.harvester_rpc_client import HarvesterRpcClient
...
from avocado.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_pooling_authentication_sk
...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "avo"), encode_puzzle_hash(new_ph_2, "avo"))
            ...
            await client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "avo"))
            ...
            assert config["farmer"]["avo_target_address"] == encode_puzzle_hash(new_ph, "avo")
            assert config["pool"]["avo_target_address"] == encode_puzzle_hash(new_ph_3, "avo")

            new_ph_3_encoded = encode_puzzle_hash(new_ph_3, "avo")

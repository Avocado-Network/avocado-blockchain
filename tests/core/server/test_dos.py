...
from avocado.protocols.shared_protocol import Handshake
from avocado.server.outbound_message import make_msg, Message
from avocado.server.rate_limits import RateLimiter
from avocado.server.server import ssl_context_for_client
...
class TestDos:
    ...
    async def test_large_message_disconnect_and_ban(self, setup_two_nodes):
        ...
        ssl_context = ssl_context_for_client(
            server_2.avocado_ca_crt_path, server_2.avocado_ca_key_path, server_2.p2p_crt_path, server_2.p2p_key_path
        )
    ...
    async def test_spam_tx(self, setup_two_nodes):
        ...
        ws_con: WSAvocadoConnection = list(server_1.all_connections.values())[0]
        ws_con_2: WSAvocadoConnection = list(server_2.all_connections.values())[0]
